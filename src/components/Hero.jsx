    ...
    return (
        ...
        <main className='relative w-full h-screen overflow-hidden flex justify-center mb-[10%]'>
            ...
            <div className='absolute bottom-[15%] flex flex-col items-center gap-5'>
                <img src="./images/illu-text.png" alt="Illu-Text" className='md:w-[30rem] w-[20rem]' />
                <h1 className='md:text-2xl text-1xl font-bold'>Explore, Capture, Conquer</h1>

                <div className='md:w-[75%] w-[60%] h-[0.1px] bg-[#baba]'></div>
                <button className='h-10 px-16 bg-gradient-to-r from-purple-500
                     to-indigo-600 rounded-lg font-medium text-nowrap hover:opacity-70
                     transition-all duration-300'>
                    PLAY NOW
                </button>
                <div className='flex items-center gap-5 text-font-extrabold text-gray-200'>
                    <img className='md:h-16 h-12'
                        src="./images/illu-logo.png" alt="Illu-Logo" /> ZERO
                </div>
                <p className='max-w-[80%] text-center text-[#babaff]'>
                    Notice: Illuvium Game is in Beta.
                    Participation Involves risk. Read
